...
CTX = {
    ...
    "broadcast": [
        {"ts": "09:31:02", "tag": "SYSTEM", "actor": "",              "msg": "连上 Alpaca paper · 准备开工",                                              "level": "info"},
        {"ts": "09:31:04", "tag": "SYSTEM", "actor": "",              "msg": "加载策略 momentum-rotation(k=5,持仓 3 天)",                                "level": "info"},
        {"ts": "09:31:08", "tag": "SYSTEM", "actor": "",              "msg": "开盘了 · NYSE 常规交易,延迟 142ms",                                          "level": "info"},
        {"ts": "09:31:12", "tag": "AGENT",  "actor": "[Screener]",    "msg": "扫一遍 SP500 候选 487 支,价 / 量 / 动量三道筛",                              "level": "info"},
        {"ts": "09:31:18", "tag": "AGENT",  "actor": "[Screener]",    "msg": "筛完了 · 12 支符合条件,NVDA / AMD / MSFT / GOOGL 排前面",                    "level": "done"},
        {"ts": "09:31:21", "tag": "AGENT",  "actor": "[Risk]",        "msg": "护栏过了一遍 · 单仓 ≤10% / 日内 DD ≤3%,都通过",                              "level": "done"},
        {"ts": "09:31:24", "tag": "DECIDE", "actor": "[mom-rot]",     "msg": "准备买入 NVDA 5 股 —— 50DMA 上穿 200DMA + 量能放大 1.8x,动量入场",          "level": "info"},
        {"ts": "09:31:25", "tag": "ORDER",  "actor": "[Trader]",      "msg": "单已发出 · NVDA buy 5 · 市价",                                              "level": "info"},
        {"ts": "09:31:27", "tag": "FILL",   "actor": "[Broker]",      "msg": "成交了 · NVDA 5 股 @ $892.40,几乎贴市价",                                   "level": "done"},
        {"ts": "09:31:30", "tag": "AGENT",  "actor": "[Screener]",    "msg": "AMD 信号弱化了(量能回落到 0.6x 以下),撤回买入意向",                         "level": "info"},
        {"ts": "09:31:34", "tag": "HOLD",   "actor": "[mom-rot]",     "msg": "AAPL 暂不动 —— 已持仓 22 股,信号没变,继续拿着",                             "level": "info"},
        {"ts": "09:31:41", "tag": "AGENT",  "actor": "[Risk]",        "msg": "组合 β 漂到 1.18(目标 1.0±0.2),还在阈值里",                               "level": "info"},
        {"ts": "09:31:48", "tag": "WARN",   "actor": "[Risk]",        "msg": "TSLA 波动率突增到 2.4σ,我把止损线从 -3% 收到 -1.8%",                        "level": "warn"},
        {"ts": "09:31:53", "tag": "DECIDE", "actor": "[mom-rot]",     "msg": "准备卖出 META 3 股 @ 限价 612.50 —— 触发 +18.2% 止盈线,锁定收益",            "level": "info"},
        {"ts": "09:31:54", "tag": "ORDER",  "actor": "[Trader]",      "msg": "单已发出 · META sell 3 · 限价 612.50",                                      "level": "info"},
        {"ts": "09:31:58", "tag": "FILL",   "actor": "[Broker]",      "msg": "成交了 · META 3 股 @ $612.58,realized P&L +$324.18",                       "level": "done"},
        {"ts": "09:32:02", "tag": "AGENT",  "actor": "[Report]",      "msg": "小时汇报写完了,已经推到 WebChat",                                            "level": "done"},
        {"ts": "09:32:05", "tag": "SYSTEM", "actor": "",              "msg": "10:32 没事干,先眯一下,11:00 再看",                                          "level": "info"},
    ],
    "feed": [
